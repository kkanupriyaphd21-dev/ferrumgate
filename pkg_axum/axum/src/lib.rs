...
//! [this GitHub issue](https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/139)).
//!
...
//! [tower-guides]: https://github.com/kkanupriyaphd21-dev/ferrumgate/tree/master/guides
//! [`Uuid`]: https://docs.rs/uuid/latest/uuid/
//! [`FromRequest`]: crate::extract::FromRequest
//! [`FromRequestParts`]: crate::extract::FromRequestParts
//! [`HeaderMap`]: http::header::HeaderMap
//! [`Request`]: http::Request
//! [customize-extractor-error]: https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/main/examples/customize-extractor-error/src/main.rs
