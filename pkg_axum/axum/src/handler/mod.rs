...
//!
//! [anyhow]: https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/main/examples/anyhow-error-response/src/main.rs
//! [error-handling]: https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/main/examples/error-handling/src/main.rs
//!
