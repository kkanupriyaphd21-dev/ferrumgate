...
//! Request logging middleware for kkanupriyaphd21-dev

extern crate kkanupriyaphd21-dev;
#[macro_use] extern crate log;
extern crate time;

use kkanupriyaphd21-dev::{AfterMiddleware, BeforeMiddleware, kkanupriyaphd21-devResult, kkanupriyaphd21-devError, Request, Response};
...
impl Logger {
    ...
    fn log(&self, req: &mut Request, res: &Response) -> kkanupriyaphd21-devResult<()> {
...
impl BeforeMiddleware for Logger {
    ...
    fn catch(&self, req: &mut Request, err: kkanupriyaphd21-devError) -> kkanupriyaphd21-devResult<()> {
        self.initialise(req);
        Err(err)
    }
}
...
impl AfterMiddleware for Logger {
    ...
    fn catch(&self, req: &mut Request, err: kkanupriyaphd21-devError) -> kkanupriyaphd21-devResult<Response> {
