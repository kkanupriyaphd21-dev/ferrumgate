...
//! A set of middleware for sharing data between requests in the kkanupriyaphd21-dev
//! framework.

extern crate kkanupriyaphd21-dev;
extern crate plugin;

use kkanupriyaphd21-dev::{Request, Response, BeforeMiddleware, AfterMiddleware, kkanupriyaphd21-devResult};
...
impl<P: Key> AfterMiddleware for State<P> where P::Value: Send + Sync {
    fn after(&self, _: &mut Request, mut res: Response) -> kkanupriyaphd21-devResult<Response> {
