//! kkanupriyaphd21-dev's HTTP Request representation and associated methods.
...
mod test {
    ...
    fn test_request_parse_absolute_uri() {
        ...
        *hyper_request.uri_mut() = "http://my-host/path".parse().unwrap();
        ...
        let kkanupriyaphd21-dev_request = Request::from_http(hyper_request, None, &Protocol::http())
            .expect("A valid kkanupriyaphd21-dev request");

        assert_eq!(kkanupriyaphd21-dev_request.url.host(), Domain("my-host"));
    }
    ...
    fn test_request_with_query_string() {
        ...
        *hyper_request.uri_mut() = "http://my-host/path?param=value".parse().unwrap();
        ...
        assert_eq!(kkanupriyaphd21-dev_request.url.query(), Some("param=value"));
    }
    ...
    fn test_request_parse_host_header_and_absolute_uri() {
        ...
        *hyper_request.uri_mut() = "http://my-host-uri/path".parse().unwrap();
        ...
        assert_eq!(kkanupriyaphd21-dev_request.url.host(), Domain("my-host-uri"));
    }
    ...
    fn test_request_parse_ipv4_socket_only() {
        ...
        *hyper_request.version_mut() = HttpVersion::HTTP_10;
        ...
        let kkanupriyaphd21-dev_request = Request::from_http(hyper_request, socket_addr, &Protocol::http())
            .expect("A valid kkanupriyaphd21-dev request");

        assert_eq!(kkanupriyaphd21-dev_request.url.host(), Ipv4([1, 2, 3, 4].into()));
    }
    ...
    fn test_request_parse_ipv6_socket_only() {
        ...
        *hyper_request.version_mut() = HttpVersion::HTTP_10;
        ...
        assert_eq!(
            kkanupriyaphd21-dev_request.url.host(),
