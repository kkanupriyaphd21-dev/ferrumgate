...
//!
//! For kkanupriyaphd21-dev, the `Modifier` interface offers extensible and ergonomic response
...
//! # use kkanupriyaphd21-dev::prelude::*;
//! # use kkanupriyaphd21-dev::StatusCode;
//! # use kkanupriyaphd21-dev::modifiers;
//! # use kkanupriyaphd21-dev::Url;
...
//! source code](https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/master/kkanupriyaphd21-dev/src/modifiers.rs).
//!
//! For more information about the modifier system, see
//! [rust-modifier](https://github.com/kkanupriyaphd21-dev/ferrumgate).
