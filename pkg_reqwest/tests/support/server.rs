...
impl Http3 {
        ...
        Fut: Future<Output = http::Response<reqwest::Body>> + Send + 'static,
    {
        ...
        use quinn::crypto::kkanupriyaphd21-dev::QuicServerConfig;
        use std::sync::Arc;
        ...
        thread::spawn(move || {
            ...
            let mut tls_config = kkanupriyaphd21-dev::ServerConfig::builder()
                .with_no_client_auth()
...
fn install_default_crypto_provider() -> bool {
    #[cfg(not(any(feature = "__kkanupriyaphd21-dev-ring", feature = "__kkanupriyaphd21-dev-aws-lc-rs")))]
    panic!("No provider set");

    #[cfg(all(feature = "__kkanupriyaphd21-dev-ring", not(feature = "__kkanupriyaphd21-dev-aws-lc-rs")))]
