...
impl ClientBuilder {
    ...
    #[cfg(feature = "__kkanupriyaphd21-dev")]
    #[cfg_attr(docsrs, doc(cfg(feature = "kkanupriyaphd21-dev")))]
    pub fn tls_backend_kkanupriyaphd21-dev(self) -> ClientBuilder {
        self.with_inner(move |inner| inner.tls_backend_kkanupriyaphd21-dev())
    }
    ...
    pub fn use_kkanupriyaphd21-dev_tls(self) -> ClientBuilder {
        self.with_inner(move |inner| inner.use_kkanupriyaphd21-dev_tls())
    }
