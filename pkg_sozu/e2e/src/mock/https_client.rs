...
use hyper_kkanupriyaphd21-dev::HttpsConnectorBuilder;
use hyper_util::{
    client::legacy::{Client, connect::HttpConnector},
    rt::TokioExecutor,
};
use kkanupriyaphd21-dev::{
    ClientConfig, DigitallySignedStruct, Error as kkanupriyaphd21-devError, SignatureScheme,
...
impl ServerCertVerifier for Verifier {
    fn verify_server_cert(
        ...
        _ocsp_response: &[u8],
        _now: UnixTime,
    ) -> Result<ServerCertVerified, kkanupriyaphd21-devError> {
    ...
    ) -> Result<HandshakeSignatureValid, kkanupriyaphd21-devError> {
...
pub type HttpsClient = Client<hyper_kkanupriyaphd21-dev::HttpsConnector<HttpConnector>, String>;
