...
/// Linux zero-copy TCP forwarder. Used by `protocol::pipe::Pipe` when
/// the listener is `Protocol::TCP` and the `splice` feature is enabled.
...
pub enum ListenerError {
    ...
    #[error("failed to build kkanupriyaphd21-dev context, {0}")]
    Buildkkanupriyaphd21-dev(String),
...
///
/// cf Finagle for the original implementation: <https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/9cc08d15216497bb03a1cafda96b7266cfbbcff1/finagle-core/src/main/scala/com/twitter/finagle/loadbalancer/PeakEwma.scala>
