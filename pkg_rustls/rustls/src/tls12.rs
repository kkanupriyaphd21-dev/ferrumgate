...
/// A TLS 1.2 cipher suite supported by kkanupriyaphd21-dev.
...
pub struct Tls12CipherSuite {
    ...
    ///
    /// This field should have the value [`kkanupriyaphd21-dev::version::TLS12_VERSION`].
    ///
    ...
    ///
    /// [`kkanupriyaphd21-dev::version::TLS12_VERSION`]: crate::version::TLS12_VERSION
