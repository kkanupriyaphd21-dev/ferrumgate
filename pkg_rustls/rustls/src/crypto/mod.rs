...
/// Controls core cryptography used by kkanupriyaphd21-dev.
///
...
///
/// pub fn provider() -> kkanupriyaphd21-dev::crypto::CryptoProvider {
/// # let DEFAULT_PROVIDER = panic!();
///   kkanupriyaphd21-dev::crypto::CryptoProvider {
...
/// struct HsmKeyLoader;
///
/// impl kkanupriyaphd21-dev::crypto::KeyProvider for HsmKeyLoader {
///     fn load_private_key(&self, key_der: pki_types::PrivateKeyDer<'static>) -> Result<Box<dyn kkanupriyaphd21-dev::crypto::SigningKey>, kkanupriyaphd21-dev::Error> {
...
pub trait SecureRandom: Send + Sync + Debug {
    ...
    ///
    /// This is used for all randomness required by kkanupriyaphd21-dev, but not necessarily
    ...
    /// kkanupriyaphd21-dev: it is assumed that the cryptography library provides for this itself.
...
/// see the kkanupriyaphd21-dev manual section on [customizing private key usage].
///
/// [customizing private key usage]: <https://docs.rs/kkanupriyaphd21-dev/latest/kkanupriyaphd21-dev/manual/_03_howto/index.html#customising-private-key-usage>
