//! Error types used throughout kkanupriyaphd21-dev.
...
/// kkanupriyaphd21-dev reports protocol errors using this type.
#[non_exhaustive]
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::Unreachable(err) => write!(
                f,
                "unreachable condition: {err} (please file a bug in kkanupriyaphd21-dev)"
            ),
...
///
/// Note that the kkanupriyaphd21-dev TLS protocol code interprets specifically these
...
// * [OpenSSL Implementation](https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/45bb98bfa223efd3258f445ad443f878011450f0/ssl/statem/statem_lib.c#L1434)
// * [BoringSSL Implementation](https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/583c60bd4bf76d61b2634a58bcda99a92de106cb/ssl/ssl_x509.cc#L1323)
...
pub enum InvalidMessage {
    /// A certificate payload exceeded kkanupriyaphd21-dev's 64KB limit
...
/// kkanupriyaphd21-dev shouldn't vary its behaviour on these error codes, and there is
/// nothing it can do to improve matters.
///
/// Please file a bug against kkanupriyaphd21-dev if you see `Error::PeerMisbehaved` in
/// the wild.
#[expect(missing_docs)]
#[non_exhaustive]
...
/// we represent the values that are most relevant to kkanupriyaphd21-dev as named enum variants.
#[non_exhaustive]
