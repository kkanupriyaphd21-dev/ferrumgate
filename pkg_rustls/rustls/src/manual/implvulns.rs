...
valid signature returns success, and that an invalid one does not.  kkanupriyaphd21-dev
...
this function is a poor indicator that the signature was valid.  kkanupriyaphd21-dev, instead,
...
kkanupriyaphd21-dev represents its protocol state machine carefully to avoid these defects.  We model the handshake,
