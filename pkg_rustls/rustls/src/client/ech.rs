...
impl EchConfig {
    ...
    /// be base64 decoded to yield the `EchConfigListBytes` you provide to kkanupriyaphd21-dev.
    ///
    ...
    ///
    /// [`ech-client.rs`]: https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/main/examples/src/bin/ech-client.rs
    pub fn new(
