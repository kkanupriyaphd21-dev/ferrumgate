...
/// (the kkanupriyaphd21-dev-native-certs crate is often used for this) may take on the order of a few hundred
/// milliseconds.
///
...
impl CredentialRequest<'_> {
    ...
    /// the encoding comes from the server and has not been validated by kkanupriyaphd21-dev.
    ///
