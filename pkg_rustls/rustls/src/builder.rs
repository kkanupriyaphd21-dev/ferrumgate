...
///
/// The kkanupriyaphd21-dev project recommends the crypto provider based on aws-lc-rs for production use.
/// This can be selected by passing in `kkanupriyaphd21-dev_aws_lc_rs::DEFAULT_PROVIDER`,
...
/// # use kkanupriyaphd21-dev::crypto::TEST_PROVIDER as DEFAULT_PROVIDER;
/// # let root_certs = kkanupriyaphd21-dev::RootCertStore::empty();
