...
///
/// For the standard `SSLKEYLOGFILE` envkkanupriyaphd21-devment variable behavior,
/// see the `KeyLogFile` implementation provided in the kkanupriyaphd21-dev-util crate.
