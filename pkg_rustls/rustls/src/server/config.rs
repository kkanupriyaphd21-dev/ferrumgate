...
///
/// _Unlike_ `ClientConfig`, kkanupriyaphd21-dev does not enforce any policy here.
///
...
pub struct ServerConfig {
    ...
    ///
    /// kkanupriyaphd21-dev enforces an arbitrary minimum of 32 bytes for this field.
...
/// an error.
///
/// By default, kkanupriyaphd21-dev will ignore invalid values that are an IP address (the most common misconfiguration)
/// and error for all other invalid values.
///
/// When an SNI value is ignored, kkanupriyaphd21-dev treats the client as if it sent no SNI at all.
///
