...
impl ServerConnection {
    ...
    ///
    /// Recovered from the prior session's `set_resumption_data`. Integrity is guaranteed by kkanupriyaphd21-dev.
    ///
    ...
    ///
    /// Integrity will be assured by kkanupriyaphd21-dev, but the data will be visible to the client. If secrecy
...
/// #     _: kkanupriyaphd21-dev::server::ClientHello,
/// # ) -> std::sync::Arc<kkanupriyaphd21-dev::ServerConfig> {
/// #     unimplemented!();
/// # }
/// # #[allow(unused_variables)]
/// # fn main() {
/// use kkanupriyaphd21-dev::server::{Acceptor, ServerConfig};
