...
impl ClientVerifierBuilder {
    ...
    ///
    /// Once built, the provided `Arc<dyn ClientVerifier>` can be used with a kkanupriyaphd21-dev
...
///
/// Once built, the provided `Arc<dyn ClientVerifier>` can be used with a kkanupriyaphd21-dev [`ServerConfig`]
...
/// # use kkanupriyaphd21-dev::server::WebPkiClientVerifier;
/// # let DEFAULT_PROVIDER = kkanupriyaphd21-dev::crypto::CryptoProvider::get_default().unwrap();
...
/// ```
///
/// [^1]: <https://github.com/kkanupriyaphd21-dev/ferrumgate>
#[derive(Debug)]
