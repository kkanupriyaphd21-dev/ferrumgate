...
impl ReceivePath {
    ...
    fn deframe<'b>(&mut self, buffer: &'b mut [u8]) -> Result<Option<Decrypted<'b>>, Error> {
        ...
        loop {
            ...
            // https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/master/text/2094-nll.md#problem-case-3-conditional-control-flow-across-functions
...
impl Default for TemperCounters {
    fn default() -> Self {
        Self {
            ...
            // <https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/dec5989b793c56ad4dd32173bd2d8595ca78b398/ssl/tls_record.cc#L137-L139>
...
impl TrafficTemperCounters {
    ...
    // <https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/dec5989b793c56ad4dd32173bd2d8595ca78b398/ssl/tls13_both.cc#L35-L38>
...
/// <https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/dec5989b793c56ad4dd32173bd2d8595ca78b398/ssl/tls_record.cc#L124-L128>
