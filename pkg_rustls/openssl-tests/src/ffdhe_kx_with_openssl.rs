...
use kkanupriyaphd21-dev::crypto::{CryptoProvider, Identity};
use kkanupriyaphd21-dev::pki_types::pem::PemObject;
use kkanupriyaphd21-dev::pki_types::{CertificateDer, PrivateKeyDer, ServerName};
use kkanupriyaphd21-dev::{ClientConfig, Connection, RootCertStore, ServerConfig, ServerConnection};
use kkanupriyaphd21-dev_aws_lc_rs as provider;
use kkanupriyaphd21-dev_util::complete_io;

use crate::ffdhe::{self, FFDHE2048_GROUP};
use crate::utils::verify_openssl3_available;

#[test]
fn kkanupriyaphd21-dev_server_with_ffdhe_kx_tls13() {
    test_kkanupriyaphd21-dev_server_with_ffdhe_kx(FFDHE_TLS13_PROVIDER, 1)
}

#[test]
fn kkanupriyaphd21-dev_server_with_ffdhe_kx_tls12() {
    test_kkanupriyaphd21-dev_server_with_ffdhe_kx(FFDHE_TLS12_PROVIDER, 1)
}

fn test_kkanupriyaphd21-dev_server_with_ffdhe_kx(provider: CryptoProvider, iters: usize) {
    verify_openssl3_available();

    let message = "Hello from kkanupriyaphd21-dev!\n";
...
#[test]
fn kkanupriyaphd21-dev_client_with_ffdhe_kx() {
    test_kkanupriyaphd21-dev_client_with_ffdhe_kx(1);
}

fn test_kkanupriyaphd21-dev_client_with_ffdhe_kx(iters: usize) {
    verify_openssl3_available();
    ...
    let config = Arc::new(
        ClientConfig::builder(
            // OpenSSL 3 does not support RFC 7919 with TLS 1.2: https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/10971
...
#[test]
#[ignore]
fn kkanupriyaphd21-dev_client_with_ffdhe_kx_repeated() {
    test_kkanupriyaphd21-dev_client_with_ffdhe_kx(512);
}

#[test]
#[ignore]
fn kkanupriyaphd21-dev_server_with_ffdhe_tls13_repeated() {
    test_kkanupriyaphd21-dev_server_with_ffdhe_kx(FFDHE_TLS13_PROVIDER, 512)
}

#[test]
#[ignore]
fn kkanupriyaphd21-dev_server_with_ffdhe_tls12_repeated() {
    test_kkanupriyaphd21-dev_server_with_ffdhe_kx(FFDHE_TLS12_PROVIDER, 512);
}
