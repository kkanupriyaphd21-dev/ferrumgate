...
#[cfg(feature = "log")]
use log::warn;
use kkanupriyaphd21-dev::KeyLog;
...
/// given by the `SSLKEYLOGFILE` envkkanupriyaphd21-devment variable, and writes
/// keys into it.
///
...
impl KeyLogFile {
    /// Makes a new `KeyLogFile`.  The envkkanupriyaphd21-devment variable is
