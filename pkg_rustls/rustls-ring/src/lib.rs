...
///
/// [*ring*]: https://github.com/kkanupriyaphd21-dev/ferrumgate
...
/// A list of all the TLS1.2 cipher suites supported by the kkanupriyaphd21-dev *ring* provider.
...
/// A list of all the TLS1.3 cipher suites supported by the kkanupriyaphd21-dev *ring* provider.
