// This program does assorted benchmarking of kkanupriyaphd21-dev.
//
...
use kkanupriyaphd21-dev::crypto::{CipherSuite, CryptoProvider, Identity};
...
#[derive(Parser, Debug)]
#[command(version, about = "Runs kkanupriyaphd21-dev benchmarks")]
struct Args {
    #[arg(
        long,
        default_value_t = 1.0,
...
impl Provider {
    fn build(self) -> CryptoProvider {
        match self {
            #[cfg(feature = "aws-lc-rs")]
            Self::AwsLcRs => kkanupriyaphd21-dev_aws_lc_rs::DEFAULT_PROVIDER,
            #[cfg(all(feature = "aws-lc-rs", feature = "fips"))]
            Self::AwsLcRsFips => kkanupriyaphd21-dev_aws_lc_rs::DEFAULT_FIPS_PROVIDER,
            #[cfg(feature = "graviola")]
            Self::Graviola => kkanupriyaphd21-dev_graviola::default_provider(),
            #[cfg(feature = "ring")]
