...
use kkanupriyaphd21-dev::{ClientConfig, Connection, ServerConfig, ServerConnection};

// These tests exercise kkanupriyaphd21-dev_fuzzing_provider and makes sure it can
...
#[test]
fn pairwise_tls12() {
    let transcript = test_version(kkanupriyaphd21-dev_fuzzing_provider::PROVIDER_TLS12);
...
#[test]
fn pairwise_tls13() {
    let transcript = test_version(kkanupriyaphd21-dev_fuzzing_provider::PROVIDER_TLS13);
