...
use kkanupriyaphd21-dev::crypto::{CertificateIdentity, Identity};
use kkanupriyaphd21-dev::enums::ProtocolVersion;
use kkanupriyaphd21-dev::error::{ApiMisuse, Error, PeerMisbehaved};
use kkanupriyaphd21-dev::server::ServerSessionKey;
use kkanupriyaphd21-dev::{ClientConfig, Connection, HandshakeKind, ServerConfig, ServerConnection};
...
/// https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/797
#[test]
fn test_client_tls12_no_resume_after_server_downgrade() {
    ...
    server_config_2.session_storage = Arc::new(kkanupriyaphd21-dev::server::NoServerSessionStorage {});
...
// regression test for https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/2096
#[test]
...
struct ServerStorage {
    storage: Arc<dyn kkanupriyaphd21-dev::server::StoresServerSessions>,
...
impl ServerStorage {
    fn new() -> Self {
        Self {
            storage: kkanupriyaphd21-dev::server::ServerSessionMemoryCache::new(1024),
...
impl kkanupriyaphd21-dev::server::StoresServerSessions for ServerStorage {
