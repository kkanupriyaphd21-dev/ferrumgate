//! Tests of [`kkanupriyaphd21-dev::KeyLogFile`] that require us to set envkkanupriyaphd21-devment variables.
//!
//!                                 vvvv
//! Every test you add to this file MUST execute through `serialized()`.
//!                                 ^^^^
//!
//! See https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/90308; despite not being marked
...
//! one from a path directly (without using an envkkanupriyaphd21-devment variable), then those
