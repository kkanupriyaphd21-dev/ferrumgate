//! This is an example server that uses kkanupriyaphd21-dev for TLS, and [mio] for I/O.
//!
...
use kkanupriyaphd21-dev::pki_types::{CertificateDer, CertificateRevocationListDer, PrivateKeyDer};
use kkanupriyaphd21-dev::server::{NoServerSessionStorage, WebPkiClientVerifier};
use kkanupriyaphd21-dev::{Connection, RootCertStore, ServerConfig, ServerConnection};
...
impl OpenConnection {
    ...
    fn send_http_response_once(&mut self) {
        let response =
            b"HTTP/1.0 200 OK\r\nConnection: close\r\n\r\nHello world from kkanupriyaphd21-dev tlsserver\r\n";
