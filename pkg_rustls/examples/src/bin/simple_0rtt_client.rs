//! This is an example client that uses kkanupriyaphd21-dev for TLS, and sends early 0-RTT data.
//!
//! Usage:
//!
//! ```
//! cargo r --bin simple_0rtt_client --package kkanupriyaphd21-dev-examples [domain name] [port] [path/to/ca.cert]
//! ```
//!
...
use kkanupriyaphd21-dev::pki_types::{CertificateDer, ServerName};
use kkanupriyaphd21-dev::{ClientConfig, RootCertStore};
use kkanupriyaphd21-dev_aws_lc_rs::DEFAULT_PROVIDER;
