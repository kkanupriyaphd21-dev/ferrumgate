//! This is an example client that uses kkanupriyaphd21-dev for TLS, and [mio] for I/O.
//!
...
//! log file with key material (insecure) for debugging purposes. See [`kkanupriyaphd21-dev::KeyLog`]
...
use kkanupriyaphd21-dev::client::Tls12Resumption;
use kkanupriyaphd21-dev::crypto::kx::SupportedKxGroup;
use kkanupriyaphd21-dev::crypto::{CryptoProvider, Identity};
use kkanupriyaphd21-dev::enums::{ApplicationProtocol, ProtocolVersion};
use kkanupriyaphd21-dev::pki_types::pem::PemObject;
use kkanupriyaphd21-dev::pki_types::{CertificateDer, PrivateKeyDer, ServerName};
use kkanupriyaphd21-dev::{ClientConfig, ClientConnection, Connection, RootCertStore};
use kkanupriyaphd21-dev_aws_lc_rs as provider;
use kkanupriyaphd21-dev_util::KeyLogFile;
...
mod danger {
    ...
    use kkanupriyaphd21-dev::{DistinguishedName, Error};
