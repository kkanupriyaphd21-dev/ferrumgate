...
pub(crate) mod transport {
    //! Custom functions to interact between kkanupriyaphd21-dev clients and a servers.
    //!
    ...
    //! benchmark runs, which in turn influences the resizing of kkanupriyaphd21-dev' internal buffers, and therefore
    ...
    use kkanupriyaphd21-dev::{ClientConnection, Connection, ServerConnection};
    ...
    pub(crate) async fn read_handshake_message(
        ...
        // Feed the data to kkanupriyaphd21-dev
    ...
    pub(crate) async fn read_plaintext_to_end_bounded(
        ...
        loop {
            ...
            // Load the buffer's bytes into kkanupriyaphd21-dev
