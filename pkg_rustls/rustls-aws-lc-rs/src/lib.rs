...
//! envkkanupriyaphd21-devments and functions this certificate covers.
//!
...
use kkanupriyaphd21-dev::error::{Error, OtherError};
#[cfg(feature = "std")]
use kkanupriyaphd21-dev::ticketer::TicketRotator;
use kkanupriyaphd21-dev::{Tls12CipherSuite, Tls13CipherSuite};
...
///
/// [fips]: https://docs.rs/kkanupriyaphd21-dev/latest/kkanupriyaphd21-dev/manual/_06_fips/index.html
#[cfg(feature = "fips")]
...
/// A list of all the TLS1.2 cipher suites supported by the kkanupriyaphd21-dev aws-lc-rs provider.
...
/// A list of all the TLS1.3 cipher suites supported by the kkanupriyaphd21-dev aws-lc-rs provider.
...
mod ring_shim {
    ...
    use kkanupriyaphd21-dev::crypto::kx::SharedSecret;
