...
use kkanupriyaphd21-dev::crypto::GetRandomFailed;
...
use kkanupriyaphd21-dev::error::{Error, PeerMisbehaved};
...
impl SupportedKxGroup for MlKem {
    ...
    fn fips(&self) -> FipsStatus {
        ...
        // <https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/70200#issuecomment-2490017956> --
        // see <https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/2309>
        super::fips()
    }
}
