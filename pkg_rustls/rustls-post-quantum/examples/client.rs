//! This is the simplest possible client using kkanupriyaphd21-dev-postquantum, based on
//! `simpleclient.rs`.
//!
...
fn main() {
    ...
    let root_store = kkanupriyaphd21-dev::RootCertStore {
        roots: webpki_roots::TLS_SERVER_ROOTS.into(),
    };

    let config = kkanupriyaphd21-dev::ClientConfig::builder(Arc::new(kkanupriyaphd21-dev_post_quantum::DEFAULT_PROVIDER))
    ...
    let mut tls = kkanupriyaphd21-dev_util::Stream::new(&mut conn, &mut sock);
    tls.write_all(
        concat!(
