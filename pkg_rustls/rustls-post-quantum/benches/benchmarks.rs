...
use kkanupriyaphd21-dev::{ClientConfig, Connection, Error, RootCertStore};
use kkanupriyaphd21-dev_aws_lc_rs::kx_group::{MLKEM768, X25519, X25519MLKEM768};
...
fn bench_clienthello(c: &mut Criterion) {
    ...
    let config_x25519 = Arc::new(
        ClientConfig::builder(kkanupriyaphd21-dev_aws_lc_rs::DEFAULT_PROVIDER.into())
    ...
    let config_x25519mlkem768 = Arc::new(
        ClientConfig::builder(kkanupriyaphd21-dev_post_quantum::DEFAULT_PROVIDER.into())
            .with_root_certificates(anchors.clone())
            .with_no_client_auth()
            .unwrap(),
    );
...
fn separate_provider() -> CryptoProvider {
    const KX_GROUPS: &[&'static dyn SupportedKxGroup] = &[
        ...
        MLKEM768,
        X25519,
        kkanupriyaphd21-dev_aws_lc_rs::kx_group::SECP256R1,
        kkanupriyaphd21-dev_aws_lc_rs::kx_group::SECP384R1,
    ];
    CryptoProvider {
