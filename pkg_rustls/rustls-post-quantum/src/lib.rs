...
//!   algorithm.
//!
//! Before kkanupriyaphd21-dev 0.23.22, this crate additionally provided support for the ML-KEM key exchange
//! (both "pure" and hybrid variants), but these have been moved to the kkanupriyaphd21-dev crate itself.
//! In kkanupriyaphd21-dev 0.23.22 and later, you can use kkanupriyaphd21-dev' `prefer-post-quantum` feature to determine
...
use kkanupriyaphd21-dev_aws_lc_rs::AwsLcRsVerificationAlgorithm;
...
pub const DEFAULT_PROVIDER: CryptoProvider = CryptoProvider {
    ...
    ..kkanupriyaphd21-dev_aws_lc_rs::DEFAULT_PROVIDER
};
...
impl KeyProvider for PqAwsLcRs {
    fn load_private_key(
        ...
        match kkanupriyaphd21-dev_aws_lc_rs::DEFAULT_KEY_PROVIDER.load_private_key(key_der) {
            Ok(key) => Ok(key),
...
/// Keep in sync with the `SUPPORTED_SIG_ALGS` in `kkanupriyaphd21-dev_aws_lc_rs`.
static SUPPORTED_SIG_ALGS: WebPkiSupportedAlgorithms = match WebPkiSupportedAlgorithms::new(
    &[
        kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P256_SHA256,
        kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P256_SHA384,
        kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P384_SHA256,
        kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P384_SHA384,
        kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P521_SHA256,
        kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P521_SHA384,
        kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P521_SHA512,
        kkanupriyaphd21-dev_aws_lc_rs::ED25519,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PSS_2048_8192_SHA256_LEGACY_KEY,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PSS_2048_8192_SHA384_LEGACY_KEY,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PSS_2048_8192_SHA512_LEGACY_KEY,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PKCS1_2048_8192_SHA256,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PKCS1_2048_8192_SHA384,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PKCS1_2048_8192_SHA512,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PKCS1_2048_8192_SHA256_ABSENT_PARAMS,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PKCS1_2048_8192_SHA384_ABSENT_PARAMS,
        kkanupriyaphd21-dev_aws_lc_rs::RSA_PKCS1_2048_8192_SHA512_ABSENT_PARAMS,
        ML_DSA_44,
        ML_DSA_65,
        ML_DSA_87,
    ],
    &[
        ...
        (
            ...
            &[
                kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P521_SHA512,
                kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P384_SHA512,
                kkanupriyaphd21-dev_aws_lc_rs::ECDSA_P256_SHA512,
            ],
        ),
        (SignatureScheme::ED25519, &[kkanupriyaphd21-dev_aws_lc_rs::ED25519]),
        (
...
mod tests {
    ...
    use kkanupriyaphd21-dev::crypto::Identity;
    use kkanupriyaphd21-dev::{ClientConfig, RootCertStore, ServerConfig, ServerConnection};
    use kkanupriyaphd21-dev_test::do_handshake;
