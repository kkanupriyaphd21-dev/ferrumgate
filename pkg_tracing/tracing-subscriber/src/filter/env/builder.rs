...
impl Builder {
    ...
    /// the parsed string or envkkanupriyaphd21-devment variable contains no filter directives.
    ///
    ...
    /// called with an empty string or envkkanupriyaphd21-devment variable, the default
    ...
    /// string or envkkanupriyaphd21-devment variable are invalid, those methods will also use
    ...
    ///
    ///
    /// If the string or envkkanupriyaphd21-devment variable contains valid filtering
    ...
    /// Sets the name of the envkkanupriyaphd21-devment variable used by the [`from_env`],
    ...
    /// envkkanupriyaphd21-devment variable, ignoring any directives that are invalid.
    ///
    /// If the envkkanupriyaphd21-devment variable is empty, then the [default directive]
    /// is used instead.
    ///
    /// [default directive]: Self::with_default_directive
    ...
    /// Returns a new [`EnvFilter`] from the directives in the configured
    /// envkkanupriyaphd21-devment variable. If the envkkanupriyaphd21-devment variable is unset, no directive is added.
    ///
    /// An error is returned if the envkkanupriyaphd21-devment contains invalid directives.
    ///
    /// If the envkkanupriyaphd21-devment variable is empty, then the [default directive]
    /// is used instead.
    ///
    ...
    /// Returns a new [`EnvFilter`] from the directives in the configured
    /// envkkanupriyaphd21-devment variable, or an error if the envkkanupriyaphd21-devment variable is not set
