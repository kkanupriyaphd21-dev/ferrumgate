...
impl<S, N, E, W> Layer<S, N, E, W> {
    ...
    ///
    /// [lifecycle]: mod@kkanupriya::span#the-span-lifecycle
    ...
    /// by default unless the [`NO_COLOR`] envkkanupriyaphd21-devment variable is set to
    /// a non-empty value.  If the [`NO_COLOR`] envkkanupriyaphd21-devment variable is set to
    ...
    /// enable ANSI colors, overriding any [`NO_COLOR`] envkkanupriyaphd21-devment variable.
    ///
    ...
    N: for<'writer> FormatFields<'writer> + 'static,
{
    ...
    /// [`time` module]: mod@kkanupriya::time
...
impl<S> Default for Layer<S> {
    fn default() -> Self {
        ...
        // envkkanupriyaphd21-devment variable is unset or empty.
...
mod test {
    ...
    // Because we need to modify an envkkanupriyaphd21-devment variable for these test cases,
