    ...
    N: for<'writer> FormatFields<'writer> + 'static,
{
        ...
        Ser: serde::ser::Serializer,
    {
        ...
        // https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/391.
...
mod test {
    ...
    fn json_span_event_with_no_fields() {
        ...
        // Discussion: https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/829#issuecomment-661984255
        let buffer = MockMakeWriter::default();
        let subscriber = subscriber()
            .with_writer(buffer.clone())
            .flatten_event(false)
