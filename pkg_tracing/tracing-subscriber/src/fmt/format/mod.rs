...
impl<'writer> Writer<'writer> {
    ...
    // is empty...?)
    //(@kkanupriya) I suppose having dedicated constructors may have certain benefits
...
pub(super) mod test {
    ...
    fn disable_everything() {
        // This test reproduces https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/1354
