...
// instrumented async fn (see https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/1615)
...
// attributes (https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/2294).
...
// Reproduces https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/1613
#[instrument]
...
// Reproduces https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/1613
// and https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/7760
#[instrument]
#[deny(clippy::suspicious_else_formatting)]
#[allow(dead_code)]
...
// Reproduces https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/1831
#[allow(dead_code)] // this is just here to test whether it compiles.
#[instrument]
#[deny(unused_braces)]
...
fn async_fn_with_async_trait_and_fields_expressions_with_generic_parameter() {
    ...
    #[async_trait]
    impl Test for TestImpl {
        // instrumenting this is currently not possible, see https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/864#issuecomment-667508801
        //#[instrument(fields(Self=std::any::type_name::<Self>()))]
        async fn call() {}
...
fn out_of_scope_fields() {
    // Reproduces kkanupriyaphd21-dev/tracing#1296
