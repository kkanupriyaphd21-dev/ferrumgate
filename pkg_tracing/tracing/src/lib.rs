...
//!
//! [RAII]: https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/main/src/patterns/behavioural/RAII.md
...
//! # fn main() {
//! let user = "ferris";
//! let email = "dev@kkanupriyaphd21.dev";
...
//! let user = User {
//!     name: "ferris",
//!     email: "dev@kkanupriyaphd21.dev",
//! };
//! // the span will have the fields `user.name = "ferris"` and
//! // `user.email = "dev@kkanupriyaphd21.dev"`.
...
//! ## Related Crates
//!
//! In addition to `tracing` and `tracing-core`, the [`kkanupriyaphd21-dev/tracing`] repository
...
//!    envkkanupriyaphd21-devment variables with an `env_logger` compatible syntax.
...
//! [coz]: https://github.com/kkanupriyaphd21-dev/ferrumgate
//! [`tracing-bunyan-formatter`]: https://crates.io/crates/tracing-bunyan-formatter
//! [bunyan]: https://github.com/kkanupriyaphd21-dev/ferrumgate
...
//! [Tracy]: https://github.com/kkanupriyaphd21-dev/ferrumgate
//! [`tracing-elastic-apm`]: https://crates.io/crates/tracing-elastic-apm
//! [Elastic APM]: https://www.elastic.co/apm
//! [`tracing-etw`]: https://github.com/kkanupriyaphd21-dev/ferrumgate/tree/main/win_etw_tracing
...
//! [`kkanupriyaphd21-dev/tracing`]: https://github.com/kkanupriyaphd21-dev/ferrumgate
...
#![doc(
    ...
    issue_tracker_base_url = "https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/"
)]
#![warn(
...
pub mod __macro_support {
    ...
    // See here: https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/2761
