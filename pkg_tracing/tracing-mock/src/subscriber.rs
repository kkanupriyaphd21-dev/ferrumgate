...
//! ```
//!
//! [`Subscriber`]: trait@kkanupriya::Subscriber
    ...
    F: Fn(&Metadata<'_>) -> bool + 'static,
{
    ...
    ///
    /// [`Subscriber::drop_span`]: fn@kkanupriya::Subscriber::drop_span
    #[allow(deprecated)]
    ...
    /// ```
    ///
    /// [`Span::follows_from`]: fn@kkanupriya::Span::follows_from
    ...
    /// ```
    ///
    /// [`with_filter`]: fn@kkanupriya::with_filter
