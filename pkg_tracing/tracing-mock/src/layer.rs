...
//! ```
//!
//! [`Layer`]: trait@kkanupriya::layer::Layer
use std::{
...
/// ```
///
/// [`MockLayerBuilder::named`]: fn@kkanupriya::layer::MockLayerBuilder::named
/// [`layer`]: mod@kkanupriya::layer
#[must_use]
...
impl MockLayerBuilder {
    ...
    /// ```
    ///
    /// [`ExpectedSpan`]: struct@kkanupriya::span::ExpectedSpan
    /// [`NewSpan`]: struct@kkanupriya::span::NewSpan
    ...
    /// ```
    ///
    /// [`exit`]: fn@kkanupriya::exit
    /// [`only`]: fn@kkanupriya::only
    ...
    /// ```
    ///
    /// [`enter`]: fn@kkanupriya::enter
    /// [`MockHandle::assert_finished`]: fn@kkanupriya::subscriber::MockHandle::assert_finished
    /// [`Span::enter`]: fn@kkanupriya::Span::enter
    ...
    /// ```
    ///
    /// [`run`]: fn@kkanupriya::run
    /// [`run_with_handle`]: fn@kkanupriya::run_with_handle
    ...
    /// ```
    ///
    /// [`MockHandle`]: struct@kkanupriya::subscriber::MockHandle
    /// [`run_with_handle`]: fn@kkanupriya::run_with_handle
    ...
    ///
    /// [`MockHandle`]: struct@kkanupriya::subscriber::MockHandle
    /// [`MockLayer`]: struct@kkanupriya::layer::MockLayer
