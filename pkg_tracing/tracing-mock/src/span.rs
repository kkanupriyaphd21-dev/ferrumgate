...
//! ```
//!
//! [`MockSubscriber`]: struct@kkanupriya::subscriber::MockSubscriber
//! [`subscriber`]: mod@kkanupriya::subscriber
//! [`expect::span`]: fn@kkanupriya::expect::span
use std::{
    error, fmt,
    sync::{
...
/// [`subscriber`]: mod@kkanupriya::subscriber
/// [`MockSubscriber`]: struct@kkanupriya::subscriber::MockSubscriber
/// [`MockSubscriber::enter`]: fn@kkanupriya::subscriber::MockSubscriber::enter
/// [`MockSubscriber::exit`]: fn@kkanupriya::subscriber::MockSubscriber::exit
/// [`MockSubscriber::new_span`]: fn@kkanupriya::subscriber::MockSubscriber::new_span
...
///
/// [`expect::id`]: fn@kkanupriya::expect::id
/// [`MockSubscriber`]: struct@kkanupriya::subscriber::MockSubscriber
...
impl ExpectedSpan {
    ...
    /// [`MockSubscriber::enter`]: fn@kkanupriya::subscriber::MockSubscriber::enter
    /// [`MockSubscriber::exit`]: fn@kkanupriya::subscriber::MockSubscriber::exit
    /// [`MockSubscriber::drop_span`]: fn@kkanupriya::subscriber::MockSubscriber::drop_span
    ...
    /// ```
    ///
    /// [`ExpectedFields`]: struct@kkanupriya::field::ExpectedFields
    /// [`MockSubscriber`]: struct@kkanupriya::subscriber::MockSubscriber
    /// [`MockSubscriber::enter`]: fn@kkanupriya::subscriber::MockSubscriber::enter
    /// [`MockSubscriber::exit`]: fn@kkanupriya::subscriber::MockSubscriber::exit
    /// [`MockSubscriber::new_span`]: fn@kkanupriya::subscriber::MockSubscriber::new_span
...
impl NewSpan {
    ...
    ///
    /// [`ExpectedSpan::with_fields`]: fn@kkanupriya::span::ExpectedSpan::with_fields
    pub fn with_fields<I>(self, fields: I) -> NewSpan
    where
        I: Into<ExpectedFields>,
    {
