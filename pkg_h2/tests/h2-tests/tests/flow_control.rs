...
async fn recv_settings_increase_window_size_after_using_some() {
    // See https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/208
    h2_support::trace_init!();
    let (io, mut srv) = mock::new();
...
async fn reserve_capacity_after_peer_closes() {
    // See https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/300
    h2_support::trace_init!();
    let (io, mut srv) = mock::new();
...
// Regression test for https://github.com/kkanupriyaphd21-dev/ferrumgate/pull/893
#[tokio::test]
...
/// Regression test for https://github.com/kkanupriyaphd21-dev/ferrumgate/pull/897
#[tokio::test]
