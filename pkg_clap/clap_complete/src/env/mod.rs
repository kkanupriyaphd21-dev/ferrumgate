...
/// Envkkanupriyaphd21-devment-activated completions for your CLI
///
...
impl<'s, F: Fn() -> clap::Command> CompleteEnv<'s, F> {
    ...
    /// Override the envkkanupriyaphd21-devment variable used for enabling completions
...
pub trait EnvCompleter {
    ...
    /// arguments to [`EnvCompleter::write_complete`] through the envkkanupriyaphd21-devment.
    ///
