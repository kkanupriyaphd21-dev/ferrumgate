...
impl Shell {
    ...
    /// Determine the user's current shell from the envkkanupriyaphd21-devment
    ///
    /// This will read the SHELL envkkanupriyaphd21-devment variable and try to determine which shell is in use
    /// from that.
    ///
