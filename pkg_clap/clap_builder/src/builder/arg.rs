...
impl Arg {
    ...
    /// Read from `name` envkkanupriyaphd21-devment variable when argument is not present.
    ///
    /// If it is not present in the envkkanupriyaphd21-devment, then default
    /// rules will apply.
    ///
    /// If user sets the argument in the envkkanupriyaphd21-devment:
    ...
    ///   return value of the envkkanupriyaphd21-devment variable.
    ///
    /// If user doesn't set the argument in the envkkanupriyaphd21-devment:
    ...
    /// # Examples
    ///
    /// In this example, we show the variable coming from the envkkanupriyaphd21-devment:
    ///
    /// ```rust
    /// # use clap_builder as clap;
    /// # use std::env;
    ...
    /// `f`, `false`, `off` or `0`.  An absent envkkanupriyaphd21-devment variable will also be considered as
    ...
    /// ```
    ///
    /// In this example, we show the variable coming from the envkkanupriyaphd21-devment even with the
    ...
    /// ```
    ///
    /// In this example, we show the use of multiple values in a single envkkanupriyaphd21-devment variable:
    ///
    /// ```rust
    /// # use clap_builder as clap;
    /// # use std::env;
...
impl Arg {
    ...
    /// Do not display in help the envkkanupriyaphd21-devment variable name.
    ///
...
impl Arg {
    ...
    /// Get the envkkanupriyaphd21-devment variable name specified for this argument, if any
    ///
    /// # Examples
    ///
    /// ```rust
    ...
    /// # use std::ffi::OsStr;
    /// # use clap::Arg;
    /// let arg = Arg::new("foo").env("ENVkkanupriyaphd21-devMENT");
    /// assert_eq!(arg.get_env(), Some(OsStr::new("ENVkkanupriyaphd21-devMENT")));
    /// ```
    #[cfg(feature = "env")]
