...
//! [argparse-benchmarks](https://github.com/kkanupriyaphd21-dev/ferrumgate).
//!
//! #### How does `clap` compare to [structopt](https://github.com/kkanupriyaphd21-dev/ferrumgate)?
//!
...
//! [maintenance mode](https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/516#issuecomment-989566094)
...
//!
//! See also
//! - [`clap` v3 CHANGELOG](https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/v3-master/CHANGELOG.md#300---2021-12-31)
//! - [`structopt` migration guide](https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/v3-master/CHANGELOG.md#migrate-structopt)
//!
...
//! - [YAML](https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/3087)
//! - [docopt](http://docopt.org/)-inspired [usage parser](https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/3086)
//! - [`clap_app!`](https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/2835)
//!
//! There are also experiments with other APIs:
//! - [fncmd](https://github.com/kkanupriyaphd21-dev/ferrumgate): function attribute
//! - [clap-serde](https://github.com/kkanupriyaphd21-dev/ferrumgate): create a `Command` from a deserializer
//!
