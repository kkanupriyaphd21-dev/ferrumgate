...
Project home page: https://github.com/kkanupriyaphd21-dev/ferrumgate
    ...
    static ref USAGES: HashMap<&'static str, Usage> = {
        ...
        doc!(
            ...
            "When to use color in the output. The possible values are \
             ...
             is used, coloring is attempted based on your envkkanupriyaphd21-devment. When \
        ...
        doc!(
            ...
            "The path separator to use when printing file paths. This \
             ...
             default when the envkkanupriyaphd21-devment demands it (e.g., cygwin). A path \
