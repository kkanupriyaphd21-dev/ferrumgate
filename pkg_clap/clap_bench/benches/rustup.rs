...
fn build_cli() -> Command {
    Command::new("rustup")
        ...
        .subcommand(
            Command::new("run")
                .about("Run a command with an envkkanupriyaphd21-devment configured for a given toolchain")
                .after_help(RUN_HELP)
                .arg(Arg::new("toolchain").required(true))
                .arg(
                    Arg::new("command")
...
Configures an envkkanupriyaphd21-devment to use the given toolchain and then runs
