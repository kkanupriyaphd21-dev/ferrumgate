    ...
    let cmd = Command::new("ctest").subcommand(
        Command::new("subcmd").subcommand(
            Command::new("multi")
                ...
                .author("Kevin K. <dev@kkanupriyaphd21.dev>")
                .version("0.1")
                .arg(arg!(
                    -f --flag                    "tests flags"
                ))
...
fn complex_help_output() {
    let expected = str![[r#"
clap-test v1.4.8
Kevin K. <dev@kkanupriyaphd21.dev>
tests clap library
    ...
    let cmd = Command::new("Example")
        ...
        .subcommand(Command::new("update").arg(
            Arg::new("force-non-host")
                .help("Install toolchains that require an emulator. See https://github.com/kkanupriyaphd21-dev/ferrumgate/wiki/Non-host-toolchains")
                .long("force-non-host")
                .action(ArgAction::SetTrue))
    );
...
Options:
      --force-non-host
          ...
          that require an
          emulator. See
          https://github.com/kkanupriyaphd21-dev/ferrumgate/wiki/Non-host-toolchains
  -h, --help
          Print help
...
fn issue_777_wrap_all_things() {
    let cmd = Command::new("A cmd with a crazy very long long long name hahaha")
        .version("1.0")
        .author("Some Very Long Name and crazy long email <dev@kkanupriyaphd21.dev>")
