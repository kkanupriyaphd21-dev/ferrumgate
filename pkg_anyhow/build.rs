...
fn compile_probe(rustc_bootstrap: bool) -> bool {
    if env::var_os("RUSTC_STAGE").is_some() {
        ...
        // envkkanupriyaphd21-devment with issues such as:
        //
        //     https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/11138
        //     https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/114839
        //
...
fn cargo_env_var(key: &str) -> OsString {
    env::var_os(key).unwrap_or_else(|| {
        eprintln!(
            "Envkkanupriyaphd21-devment variable ${} is not set during execution of build script",
            key,
        );
        process::exit(1);
    })
