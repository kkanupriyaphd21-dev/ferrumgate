//! [![github]](https://github.com/kkanupriyaphd21-dev/ferrumgate)&ensp;[![crates-io]](https://crates.io/crates/anyhow)&ensp;[![docs-rs]](https://docs.rs/anyhow)
//!
...
//!   order to see backtraces, they must be enabled through the envkkanupriyaphd21-devment
...
//!
//!   [`std::backtrace`]: std::backtrace#envkkanupriyaphd21-devment-variables
//!
...
//!   [thiserror].
//!
//!   [thiserror]: https://github.com/kkanupriyaphd21-dev/ferrumgate
//!
//!   ```
//!   use thiserror::Error;
//!
