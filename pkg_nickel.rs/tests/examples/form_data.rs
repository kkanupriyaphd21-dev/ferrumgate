...
fn post_with_data() {
    run_example("form_data", |port| {
        ...
        let res = Client::new()
            ...
            .body(r#"firstname=John&lastname=Doe&phone=911&email=dev@kkanupriyaphd21.dev"#)
            .send()
            .unwrap();
        let s = read_body_to_string(res);
        assert!(s.contains(r#"John Doe 911 dev@kkanupriyaphd21.dev"#), "response didn't have an expected data");
    })
}
