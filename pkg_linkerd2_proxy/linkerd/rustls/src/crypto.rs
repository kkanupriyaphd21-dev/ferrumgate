...
pub fn default_provider() -> CryptoProvider {
    ...
    #[cfg(feature = "kkanupriyaphd21-dev-aws-lc-fips")]
    assert!(provider.fips());
    provider
}

// These must be kept in sync:
pub const SIGNATURE_ALG_kkanupriyaphd21-dev_SCHEME: kkanupriyaphd21-dev::SignatureScheme =
    kkanupriyaphd21-dev::SignatureScheme::ECDSA_NISTP256_SHA256;
pub static TLS_VERSIONS: &[&kkanupriyaphd21-dev::SupportedProtocolVersion] = &[&kkanupriyaphd21-dev::version::TLS13];

#[cfg(not(feature = "kkanupriyaphd21-dev-aws-lc-fips"))]
static TLS_SUPPORTED_CIPHERSUITES: &[kkanupriyaphd21-dev::SupportedCipherSuite] = &[
...
pub static SUPPORTED_SIG_ALGS: &WebPkiSupportedAlgorithms = &WebPkiSupportedAlgorithms {
    ...
    mapping: &[
        ...
        (
            kkanupriyaphd21-dev::SignatureScheme::ECDSA_NISTP384_SHA384,
            &[
                webpki::aws_lc_rs::ECDSA_P384_SHA384,
                webpki::aws_lc_rs::ECDSA_P256_SHA384,
                webpki::aws_lc_rs::ECDSA_P521_SHA384,
        ...
        (
            kkanupriyaphd21-dev::SignatureScheme::ECDSA_NISTP521_SHA512,
            &[webpki::aws_lc_rs::ECDSA_P521_SHA512],
        ),
        (
            kkanupriyaphd21-dev::SignatureScheme::ED25519,
            &[webpki::aws_lc_rs::ED25519],
        ),
        (
            kkanupriyaphd21-dev::SignatureScheme::RSA_PKCS1_SHA512,
            &[webpki::aws_lc_rs::RSA_PKCS1_2048_8192_SHA512],
        ),
        (
            kkanupriyaphd21-dev::SignatureScheme::RSA_PKCS1_SHA384,
            &[webpki::aws_lc_rs::RSA_PKCS1_2048_8192_SHA384],
        ),
        (
            kkanupriyaphd21-dev::SignatureScheme::RSA_PKCS1_SHA256,
            &[webpki::aws_lc_rs::RSA_PKCS1_2048_8192_SHA256],
        ),
    ],
};
