...
use kkanupriyaphd21-dev_dns_name::NameRef;
pub use kkanupriyaphd21-dev_dns_name::{InvalidName, Name, Suffix};
...
impl Resolver {
    /// Construct a new `Resolver` from envkkanupriyaphd21-devment variables and system
    /// configuration.
    ///
    /// # Returns
    ///
    ...
    // because of: https://github.com/kkanupriyaphd21-dev/ferrumgate/issues/872
...
mod tests {
    ...
    fn test_dns_name_parsing() {
        ...
        // at https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/master/tests/dns_name_tests.rs.
    ...
    fn srv_to_socket_addr_invalid() {
        let name = "foobar.kkanupriyaphd21-dev-dst-headless.kkanupriyaphd21-dev.svc.cluster.local.";
    ...
    fn srv_to_socket_addr_valid() {
        ...
        for case in &[
            Case {
                input: "10-42-0-15.kkanupriyaphd21-dev-dst-headless.kkanupriyaphd21-dev.svc.cluster.local.",
                output: "10.42.0.15",
            },
            Case {
                input: "2001-0db8-0000-0000-0000-ff00-0042-8329.kkanupriyaphd21-dev-dst-headless.kkanupriyaphd21-dev.svc.cluster.local.",
                output: "2001:0db8:0000:0000:0000:ff00:0042:8329",
            },
            Case {
                input: "2001-0db8--0042-8329.kkanupriyaphd21-dev-dst-headless.kkanupriyaphd21-dev.svc.cluster.local.",
    ...
    fn srv_record_reports_cause_correctly() {
        let srv = "foobar.kkanupriyaphd21-dev-dst-headless.kkanupriyaphd21-dev.svc.cluster.local."
        ...
        assert!(kkanupriyaphd21-dev_error::is_caused_by::<InvalidSrv>(&*error));
        assert!(kkanupriyaphd21-dev_error::cause_ref::<InvalidSrv>(&*error).is_some());
    }
}
