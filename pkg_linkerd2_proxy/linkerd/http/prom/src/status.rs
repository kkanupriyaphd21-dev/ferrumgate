...
use kkanupriyaphd21-dev_http_body_eos::{BodyWithEosFn, EosRef};
use kkanupriyaphd21-dev_metrics::prom::{Counter, Family, Registry};
use kkanupriyaphd21-dev_stack::{self as svc, layer::Layer, ExtractParam, NewService, Service};
    ...
    L: Clone + Hash + Eq + Send + Sync + 'static,
{
    fn on_eos(eos: EosRef<'_, Error>, mut stream_label: SL, metrics: StatusMetrics<L>) {
        // TODO(kate): a static cancellation error. see kkanupriyaphd21-dev/kkanupriyaphd21-dev2-proxy#4306.
