...
use kkanupriyaphd21-dev_app_inbound::GatewayLoop;
use kkanupriyaphd21-dev_proxy_server_policy as policy;
...
async fn upgraded_request_remains_relative_form() {
    ...
    impl svc::Param<Option<profiles::Receiver>> for Target {
        fn param(&self) -> Option<profiles::Receiver> {
            Some(kkanupriyaphd21-dev_app_test::profile::only(profiles::Profile {
    ...
    let outer = {
        ...
        let resolve = kkanupriyaphd21-dev_app_test::resolver::Dst::default().endpoint_exists(
