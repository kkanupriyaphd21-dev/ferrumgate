...
pub use kkanupriyaphd21-dev_app_core::identity::{client, Id};
use kkanupriyaphd21-dev_app_core::{
    control, dns,
    identity::{
        client::kkanupriyaphd21-dev::Certify, creds, CertMetrics, Credentials, DerX509, WithCertMetrics,
    },
...
pub enum Config {
    kkanupriyaphd21-dev {
        ...
        certify: client::kkanupriyaphd21-dev::Config,
        id: Id,
...
fn watch(
    ...
    let (store, receiver) =
        kkanupriyaphd21-dev_app_core::identity::creds::watch(id, server_name, &trust_anchors_pem)?;
