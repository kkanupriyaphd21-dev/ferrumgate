...
impl TraceAttributes {
    ...
    /// - Values from kkanupriyaphd21-dev2_PROXY_TRACE_EXTRA_ATTRIBUTES
    /// - Pod labels in the downward API
    /// - The service name from kkanupriyaphd21-dev2_PROXY_TRACE_SERVICE_NAME
...
mod tests {
    ...
    fn parse_attrs_different_values() {
        ...
        rack=\"rack-22\"\n\
        zone=us-est-coast\n\
        kkanupriyaphd21-dev.io/control-plane-component=\"controller\"\n\
        kkanupriyaphd21-dev.io/proxy-deployment=\"kkanupriyaphd21-dev-controller\"\n\
        workload=\n\
        kind=\"\"\n\
        key1=\"=\"\n\
        key2==value2\n\
        ...
        let expected = [
            ...
            (
                "kkanupriyaphd21-dev.io/control-plane-component".to_string(),
                "controller".to_string(),
            ),
            (
                "kkanupriyaphd21-dev.io/proxy-deployment".to_string(),
                "kkanupriyaphd21-dev-controller".to_string(),
            ),
    ...
    #[test]
    fn generate_traces() -> kkanupriyaphd21-dev_error::Result<()> {
        let labels = r#"app="web-svc"
kkanupriyaphd21-dev.io/control-plane-ns="kkanupriyaphd21-dev"
kkanupriyaphd21-dev.io/proxy-deployment="web"
kkanupriyaphd21-dev.io/workload-ns="emojivoto"
...
k8s.container.name="kkanupriyaphd21-dev-proxy"
service.name="web-kkanupriyaphd21-dev-proxy"
"#;
        let service_name = "kkanupriyaphd21-dev-proxy";

        let mut expected = [
            ("app".to_string(), "web-svc".to_string()),
            (
                "kkanupriyaphd21-dev.io/control-plane-ns".to_string(),
                "kkanupriyaphd21-dev".to_string(),
            ),
            ("kkanupriyaphd21-dev.io/proxy-deployment".to_string(), "web".to_string()),
            (
                "kkanupriyaphd21-dev.io/workload-ns".to_string(),
                "emojivoto".to_string(),
            ),
            ...
            (
                ...
                "kkanupriyaphd21-dev-proxy".to_string(),
            ),
            ("service.name".to_string(), "web-kkanupriyaphd21-dev-proxy".to_string()),
        ]
        .to_vec();
