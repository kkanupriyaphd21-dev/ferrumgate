...
/// An implementation of `Strings` that reads the values from envkkanupriyaphd21-devment variables.
pub struct Env;

/// Errors produced when loading a `Config` struct.
#[derive(Clone, Debug, Error)]
pub enum EnvError {
    #[error("invalid envkkanupriyaphd21-devment variable")]
    InvalidEnvVar,
    #[error("no destination service configured")]
    NoDestinationAddress,
    #[error("no policy service configured")]
    NoPolicyAddress,
    #[error("kkanupriyaphd21-dev identity requires a TLS Id and server name to be the same")]
...
// Envkkanupriyaphd21-devment variables to look at when loading the configuration
pub const ENV_OUTBOUND_LISTEN_ADDR: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_LISTEN_ADDR";
pub const ENV_OUTBOUND_LISTEN_ADDRS: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_LISTEN_ADDRS";
pub const ENV_INBOUND_LISTEN_ADDR: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_LISTEN_ADDR";
pub const ENV_CONTROL_LISTEN_ADDR: &str = "kkanupriyaphd21-dev2_PROXY_CONTROL_LISTEN_ADDR";
pub const ENV_ADMIN_LISTEN_ADDR: &str = "kkanupriyaphd21-dev2_PROXY_ADMIN_LISTEN_ADDR";

pub const ENV_METRICS_RETAIN_IDLE: &str = "kkanupriyaphd21-dev2_PROXY_METRICS_RETAIN_IDLE";

pub const ENV_SHUTDOWN_ENDPOINT_ENABLED: &str = "kkanupriyaphd21-dev2_PROXY_SHUTDOWN_ENDPOINT_ENABLED";

const ENV_INGRESS_MODE: &str = "kkanupriyaphd21-dev2_PROXY_INGRESS_MODE";

const ENV_INBOUND_HTTP_QUEUE_CAPACITY: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_HTTP_QUEUE_CAPACITY";
const ENV_INBOUND_HTTP_FAILFAST_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_HTTP_FAILFAST_TIMEOUT";

const ENV_OUTBOUND_TCP_QUEUE_CAPACITY: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_TCP_QUEUE_CAPACITY";
const ENV_OUTBOUND_TCP_FAILFAST_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_TCP_FAILFAST_TIMEOUT";
const ENV_OUTBOUND_HTTP_QUEUE_CAPACITY: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_HTTP_QUEUE_CAPACITY";
const ENV_OUTBOUND_HTTP_FAILFAST_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_HTTP_FAILFAST_TIMEOUT";

pub const ENV_INBOUND_DETECT_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_DETECT_TIMEOUT";
const ENV_OUTBOUND_DETECT_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_DETECT_TIMEOUT";

const ENV_INBOUND_CONNECT_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_CONNECT_TIMEOUT";
const ENV_OUTBOUND_CONNECT_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_CONNECT_TIMEOUT";

const ENV_INBOUND_ACCEPT_KEEPALIVE: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_ACCEPT_KEEPALIVE";
const ENV_OUTBOUND_ACCEPT_KEEPALIVE: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_ACCEPT_KEEPALIVE";

const ENV_INBOUND_CONNECT_KEEPALIVE: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_CONNECT_KEEPALIVE";
const ENV_OUTBOUND_CONNECT_KEEPALIVE: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_CONNECT_KEEPALIVE";

const ENV_INBOUND_ACCEPT_USER_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_ACCEPT_USER_TIMEOUT";
const ENV_OUTBOUND_ACCEPT_USER_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_ACCEPT_USER_TIMEOUT";

const ENV_INBOUND_CONNECT_USER_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_CONNECT_USER_TIMEOUT";
const ENV_OUTBOUND_CONNECT_USER_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_CONNECT_USER_TIMEOUT";

const ENV_INBOUND_TCP_LISTEN_BACKLOG: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_TCP_LISTEN_BACKLOG";
const ENV_OUTBOUND_TCP_LISTEN_BACKLOG: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_TCP_LISTEN_BACKLOG";

const ENV_INBOUND_MAX_IDLE_CONNS_PER_ENDPOINT: &str = "kkanupriyaphd21-dev2_PROXY_MAX_IDLE_CONNS_PER_ENDPOINT";
const ENV_OUTBOUND_MAX_IDLE_CONNS_PER_ENDPOINT: &str =
    "kkanupriyaphd21-dev2_PROXY_OUTBOUND_MAX_IDLE_CONNS_PER_ENDPOINT";

pub const ENV_INBOUND_MAX_IN_FLIGHT: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_MAX_IN_FLIGHT";
pub const ENV_OUTBOUND_MAX_IN_FLIGHT: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_MAX_IN_FLIGHT";

const ENV_OUTBOUND_DISABLE_INFORMATIONAL_HEADERS: &str =
    "kkanupriyaphd21-dev2_PROXY_OUTBOUND_DISABLE_INFORMATIONAL_HEADERS";

const ENV_OUTBOUND_METRICS_HOSTNAME_LABELS: &str =
    "kkanupriyaphd21-dev2_PROXY_OUTBOUND_METRICS_HOSTNAME_LABELS";
const ENV_INBOUND_METRICS_AUTHORITY_LABELS: &str =
    "kkanupriyaphd21-dev2_PROXY_INBOUND_METRICS_AUTHORITY_LABELS";

const ENV_TRACE_ATTRIBUTES_PATH: &str = "kkanupriyaphd21-dev2_PROXY_TRACE_ATTRIBUTES_PATH";
const ENV_TRACE_SERVICE_NAME: &str = "kkanupriyaphd21-dev2_PROXY_TRACE_SERVICE_NAME";
const ENV_TRACE_EXTRA_ATTRIBUTES: &str = "kkanupriyaphd21-dev2_PROXY_TRACE_EXTRA_ATTRIBUTES";
// This doesn't have the kkanupriyaphd21-dev2_ prefix because it is a conventional env var from OpenTelemetry:
// https://opentelemetry.io/docs/specs/otel/configuration/sdk-envkkanupriyaphd21-devment-variables/#general-sdk-configuration
...
pub const ENV_DESTINATION_PROFILE_SUFFIXES: &str = "kkanupriyaphd21-dev2_PROXY_DESTINATION_PROFILE_SUFFIXES";
...
///
/// If unspecified, a default value is used.
pub const ENV_DESTINATION_PROFILE_NETWORKS: &str = "kkanupriyaphd21-dev2_PROXY_DESTINATION_PROFILE_NETWORKS";

/// Constrains which destination names are permitted.
///
/// If unspecified or empty, no inbound gateway is configured.
pub const ENV_INBOUND_GATEWAY_SUFFIXES: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_GATEWAY_SUFFIXES";
...
pub const ENV_INBOUND_PORTS_DISABLE_PROTOCOL_DETECTION: &str =
    "kkanupriyaphd21-dev2_PROXY_INBOUND_PORTS_DISABLE_PROTOCOL_DETECTION";

pub const ENV_INBOUND_PORTS_REQUIRE_IDENTITY: &str =
    "kkanupriyaphd21-dev2_PROXY_INBOUND_PORTS_REQUIRE_IDENTITY";

pub const ENV_INBOUND_PORTS_REQUIRE_TLS: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_PORTS_REQUIRE_TLS";
...
pub const ENV_INBOUND_DEFAULT_POLICY: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_DEFAULT_POLICY";

pub const ENV_INBOUND_PORTS: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_PORTS";
pub const ENV_POLICY_SVC_BASE: &str = "kkanupriyaphd21-dev2_PROXY_POLICY_SVC";
pub const ENV_POLICY_WORKLOAD: &str = "kkanupriyaphd21-dev2_PROXY_POLICY_WORKLOAD";
pub const ENV_POLICY_CLUSTER_NETWORKS: &str = "kkanupriyaphd21-dev2_PROXY_POLICY_CLUSTER_NETWORKS";

pub const ENV_INBOUND_IPS: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_IPS";

pub const ENV_IDENTITY_DISABLED: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_DISABLED";
pub const ENV_IDENTITY_DIR: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_DIR";
pub const ENV_IDENTITY_TRUST_ANCHORS: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_TRUST_ANCHORS";
pub const ENV_IDENTITY_TOKEN_FILE: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_TOKEN_FILE";
pub const ENV_IDENTITY_MIN_REFRESH: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_MIN_REFRESH";
pub const ENV_IDENTITY_MAX_REFRESH: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_MAX_REFRESH";
...
/// name
pub const ENV_IDENTITY_IDENTITY_LOCAL_NAME: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_LOCAL_NAME";
...
pub const ENV_IDENTITY_IDENTITY_SERVER_ID: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_SERVER_ID";
...
pub const ENV_IDENTITY_IDENTITY_SERVER_NAME: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_SERVER_NAME";
...
pub const ENV_IDENTITY_SPIRE_WORKLOAD_API_ADDRESS: &str =
    "kkanupriyaphd21-dev2_PROXY_IDENTITY_SPIRE_WORKLOAD_API_ADDRESS";
pub const ENV_IDENTITY_SPIRE_SOCKET: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_SPIRE_SOCKET";

pub const IDENTITY_SPIRE_BASE: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_SPIRE";
...
pub const ENV_IDENTITY_SVC_BASE: &str = "kkanupriyaphd21-dev2_PROXY_IDENTITY_SVC";

pub const ENV_DESTINATION_SVC_BASE: &str = "kkanupriyaphd21-dev2_PROXY_DESTINATION_SVC";

pub const ENV_HOSTNAME: &str = "HOSTNAME";

pub const ENV_TRACE_COLLECTOR_SVC_BASE: &str = "kkanupriyaphd21-dev2_PROXY_TRACE_COLLECTOR_SVC";

pub const ENV_DESTINATION_CONTEXT: &str = "kkanupriyaphd21-dev2_PROXY_DESTINATION_CONTEXT";
pub const ENV_DESTINATION_PROFILE_INITIAL_TIMEOUT: &str =
    "kkanupriyaphd21-dev2_PROXY_DESTINATION_PROFILE_INITIAL_TIMEOUT";

pub const ENV_TAP_SVC_NAME: &str = "kkanupriyaphd21-dev2_PROXY_TAP_SVC_NAME";

/// Configures a minimum value for the TTL of DNS lookups.
///
/// Lookups with TTLs below this value will use this value instead.
const ENV_DNS_MIN_TTL: &str = "kkanupriyaphd21-dev2_PROXY_DNS_MIN_TTL";
/// Configures a maximum value for the TTL of DNS lookups.
///
/// Lookups with TTLs above this value will use this value instead.
const ENV_DNS_MAX_TTL: &str = "kkanupriyaphd21-dev2_PROXY_DNS_MAX_TTL";
...
const ENV_INITIAL_STREAM_WINDOW_SIZE: &str = "kkanupriyaphd21-dev2_PROXY_HTTP2_INITIAL_STREAM_WINDOW_SIZE";
const ENV_INITIAL_CONNECTION_WINDOW_SIZE: &str =
    "kkanupriyaphd21-dev2_PROXY_HTTP2_INITIAL_CONNECTION_WINDOW_SIZE";

const ENV_INBOUND_HTTP1_CONNECTION_POOL_IDLE_TIMEOUT: &str =
    "kkanupriyaphd21-dev2_PROXY_INBOUND_HTTP1_CONNECTION_POOL_IDLE_TIMEOUT";
const ENV_OUTBOUND_HTTP1_CONNECTION_POOL_IDLE_TIMEOUT: &str =
    "kkanupriyaphd21-dev2_PROXY_OUTBOUND_HTTP1_CONNECTION_POOL_IDLE_TIMEOUT";

const ENV_SHUTDOWN_GRACE_PERIOD: &str = "kkanupriyaphd21-dev2_PROXY_SHUTDOWN_GRACE_PERIOD";
...
// This configuration limits the amount of time kkanupriyaphd21-dev retains cached clients &
...
const ENV_OUTBOUND_DISCOVERY_IDLE_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_OUTBOUND_DISCOVERY_IDLE_TIMEOUT";
...
const ENV_INBOUND_DISCOVERY_IDLE_TIMEOUT: &str = "kkanupriyaphd21-dev2_PROXY_INBOUND_DISCOVERY_IDLE_TIMEOUT";
...
pub fn parse_config<S: Strings>(strings: &S) -> Result<super::Config, EnvError> {
    // Parse all the envkkanupriyaphd21-devment variables. `parse` will log any errors so
    ...
    let outbound = {
        ...
        let server = ServerConfig {
            ...
            user_timeout,
            backlog,
            http2: http2::parse_server(strings, "kkanupriyaphd21-dev2_PROXY_OUTBOUND_SERVER_HTTP2")?,
        };
    ...
    let inbound = {
        ...
        let server = ServerConfig {
            ...
            user_timeout,
            backlog,
            http2: http2::parse_server(strings, "kkanupriyaphd21-dev2_PROXY_INBOUND_SERVER_HTTP2")?,
        };
        let discovery_idle_timeout =
        ...
        let policy = {
            ...
            // If the `INBOUND_PORTS_DISABLE_PROTOCOL_DETECTION` envkkanupriyaphd21-devment
...
pub fn parse_backoff<S: Strings>(
    ...
    let min_env = format!("kkanupriyaphd21-dev2_PROXY_{base}_EXP_BACKOFF_MIN");
    let min = parse(strings, &min_env, parse_duration);
    let max_env = format!("kkanupriyaphd21-dev2_PROXY_{base}_EXP_BACKOFF_MAX");
    let max = parse(strings, &max_env, parse_duration);
    let jitter_env = format!("kkanupriyaphd21-dev2_PROXY_{base}_EXP_BACKOFF_JITTER");
