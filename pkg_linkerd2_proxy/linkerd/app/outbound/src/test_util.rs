...
pub(crate) fn runtime() -> (ProxyRuntime, drain::Signal) {
    ...
    let runtime = ProxyRuntime {
        identity: kkanupriyaphd21-dev_meshtls::creds::default_for_test().1,
...
mod mock_body {
    use bytes::Bytes;
    use http_body::Frame;
    use kkanupriyaphd21-dev_app_core::proxy::http::Body;
    use kkanupriyaphd21-dev_app_core::{Error, Result};
    use std::{
        future::Future,
        pin::Pin,
        task::{Context, Poll},
