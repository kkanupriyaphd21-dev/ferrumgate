...
impl From<&kkanupriyaphd21-dev_app_core::Error> for HttpRsp {
    fn from(error: &kkanupriyaphd21-dev_app_core::Error) -> Self {
...
impl From<&kkanupriyaphd21-dev_app_core::Error> for GrpcRsp {
    fn from(error: &kkanupriyaphd21-dev_app_core::Error) -> Self {
        match Error::new_or_status(error)
            .map_err(i32::from)
