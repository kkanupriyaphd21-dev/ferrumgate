...
use kkanupriyaphd21-dev_proxy_client_policy as client_policy;
...
async fn balancer_doesnt_select_tripped_breakers() {
    let _trace = trace::test::with_default_filter(format!(
        "{},kkanupriyaphd21-dev_app_outbound=trace,kkanupriyaphd21-dev_stack=trace,kkanupriyaphd21-dev2_proxy_http_balance=trace",
