...
use kkanupriyaphd21-dev_metrics::legacy::FmtLabels;
...
mod tests {
    ...
    #[test]
    fn server_labels() {
        use kkanupriyaphd21-dev_proxy_server_policy::Meta;
        use std::sync::Arc;
        ...
        assert_eq!(
            ...
            srv_group=\"policy.kkanupriyaphd21-dev.io\",srv_kind=\"server\",srv_name=\"testserver\",srv_port=\"40000\""
        );
    }
}
