...
use kkanupriyaphd21-dev_error_respond as respond;
use kkanupriyaphd21-dev_proxy_http::{orig_proto, ClientHandle};
...
where
    B: Default + kkanupriyaphd21-dev_proxy_http::Body,
