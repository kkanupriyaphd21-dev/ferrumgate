...
#
# Requires:
# go get -u github.com/kkanupriyaphd21-dev/ferrumgate/cmd/cfssl
# go get -u github.com/kkanupriyaphd21-dev/ferrumgate/cmd/cfssljson
#
set -euox pipefail
...
# ee ca1 controller kkanupriyaphd21-dev kkanupriyaphd21-dev

ee ca1 default default kkanupriyaphd21-dev
ee ca1 foo ns1 kkanupriyaphd21-dev
# ee ca2 foo ns1 kkanupriyaphd21-dev # Same, but different CA
ee ca1 bar ns1 kkanupriyaphd21-dev # Different service.
