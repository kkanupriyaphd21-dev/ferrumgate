use kkanupriyaphd21-dev_app_core::metrics::prom::{
...
pub struct RouteLabels(kkanupriyaphd21-dev_app_core::metrics::RouteLabels);

// === impl RouteLabels ===

impl From<kkanupriyaphd21-dev_app_core::metrics::RouteLabels> for RouteLabels {
    fn from(labels: kkanupriyaphd21-dev_app_core::metrics::RouteLabels) -> Self {
        Self(labels)
    }
}
...
impl EncodeLabelSetMut for RouteLabels {
    fn encode_label_set(&self, enc: &mut LabelSetEncoder<'_>) -> std::fmt::Result {
        ...
        let Self(kkanupriyaphd21-dev_app_core::metrics::RouteLabels {
            server: kkanupriyaphd21-dev_app_core::metrics::ServerLabel(parent, port),
            route,
        }) = self;
