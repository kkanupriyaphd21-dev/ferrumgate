...
pub use kkanupriyaphd21-dev_app_core::proxy::http::{normalize_uri, Variant};
...
use kkanupriyaphd21-dev_http_access_log::NewAccessLog;
...
impl errors::HttpRescue<Error> for ServerRescue {
    fn rescue(&self, error: Error) -> Result<errors::SyntheticHttpResponse> {
        ...
        if errors::is_caused_by::<kkanupriyaphd21-dev_proxy_server_policy::RateLimitError>(&*error) {
