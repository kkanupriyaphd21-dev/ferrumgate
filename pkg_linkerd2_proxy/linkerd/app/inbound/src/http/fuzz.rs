...
pub use kkanupriyaphd21-dev_app_test as support;
use kkanupriyaphd21-dev_app_test::*;
        ...
        let (policy, _) = policy::AllowPolicy::for_test(
            ...
            policy::ServerPolicy {
                protocol: policy::Protocol::Http1(Arc::new([
                    kkanupriyaphd21-dev_proxy_server_policy::http::default(Arc::new([policy::Authorization {
                ...
                local_rate_limit: Arc::new(kkanupriyaphd21-dev_proxy_server_policy::LocalRateLimit::default()),
            },
        );
        policy
    }
