...
impl Param<kkanupriyaphd21-dev_app_core::metrics::ProfileRouteLabels> for ProfileRoute {
    fn param(&self) -> kkanupriyaphd21-dev_app_core::metrics::ProfileRouteLabels {
        kkanupriyaphd21-dev_app_core::metrics::ProfileRouteLabels::inbound(
...
) -> impl svc::ExtractParam<kkanupriyaphd21-dev_app_core::metrics::EndpointLabels, Logical> + Clone {
    move |t: &Logical| -> kkanupriyaphd21-dev_app_core::metrics::EndpointLabels {
        kkanupriyaphd21-dev_app_core::metrics::InboundEndpointLabels {
