...
use kkanupriyaphd21-dev_proxy_server_policy::{Authentication, Authorization, Meta, Protocol, ServerPolicy};
    ...
    let policy = policy::Config::Fixed {
        ...
        default: ServerPolicy {
            protocol: Protocol::Detect {
                ...
                http: Arc::new([kkanupriyaphd21-dev_proxy_server_policy::http::default(
