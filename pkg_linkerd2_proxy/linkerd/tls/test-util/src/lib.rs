...
pub static DEFAULT_DEFAULT: Entity = Entity {
    name: "default.default.serviceaccount.identity.kkanupriyaphd21-dev.cluster.local",
    id: "default.default.serviceaccount.identity.kkanupriyaphd21-dev.cluster.local",
...
pub static FOO_NS1: Entity = Entity {
    name: "foo.ns1.serviceaccount.identity.kkanupriyaphd21-dev.cluster.local",
    id: "foo.ns1.serviceaccount.identity.kkanupriyaphd21-dev.cluster.local",
    trust_anchors: include_bytes!("testdata/ca1.pem"),
...
pub static BAR_NS1: Entity = Entity {
    name: "bar.ns1.serviceaccount.identity.kkanupriyaphd21-dev.cluster.local",
    id: "bar.ns1.serviceaccount.identity.kkanupriyaphd21-dev.cluster.local",
    trust_anchors: include_bytes!("testdata/ca1.pem"),
