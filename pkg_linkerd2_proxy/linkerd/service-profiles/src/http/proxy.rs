...
use kkanupriyaphd21-dev_stack::{layer, NewService, Param, Proxy, Service};
use std::{
...
/// `Service`.
///
/// This router is similar to `kkanupriyaphd21-dev_router::NewOneshotRoute` and
/// `kkanupriyaphd21-dev_router::Cache` with a few differences:
///
/// * It's `Proxy`-specific;
