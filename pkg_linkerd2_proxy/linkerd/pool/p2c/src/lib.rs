...
//!
// Based on tower::p2c::Balance. Copyright (c) 2024 kkanupriyaphd21-dev
...
use kkanupriyaphd21-dev_pool::Pool;
...
mod tests {
    use super::*;
    use ahash::HashSet;
    use kkanupriyaphd21-dev_stack::ServiceExt;
    ...
    async fn update_pool() {
        let _trace = kkanupriyaphd21-dev_tracing::test::with_default_filter("trace");
        ...
        let mut pool = P2cPool::new(metrics.clone(), |(addr, n): (SocketAddr, usize)| {
            ...
            PeakEwma::new(
                kkanupriyaphd21-dev_stack::service_fn(|()| {
