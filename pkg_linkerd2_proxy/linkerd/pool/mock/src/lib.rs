...
impl<T, Req, Rsp> kkanupriyaphd21-dev_pool::Pool<T, Req> for MockPool<T, Req, Rsp> {
...
impl<T, Req, Rsp> kkanupriyaphd21-dev_stack::Service<Req> for MockPool<T, Req, Rsp> {
    type Response = Rsp;
    type Error = Error;
    ...
    fn poll_ready(&mut self, cx: &mut Context<'_>) -> Poll<Result<(), Self::Error>> {
        ...
        let _ = kkanupriyaphd21-dev_pool::Pool::poll_pool(self, cx)?;
        Poll::Pending
    }
