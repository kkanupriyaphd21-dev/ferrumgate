...
pub mod proto {
    ...
    use kkanupriyaphd21-dev2_proxy_api::{inbound as api, net::InvalidIpNetwork};
    ...
    impl TryFrom<api::Authz> for Authorization {
        ...
        fn try_from(proto: api::Authz) -> Result<Self, Self::Error> {
            ...
            let meta = match metadata {
                ...
                None => {
                    Meta::try_new_with_default(labels, "policy.kkanupriyaphd21-dev.io", "serverauthorization")?
                }
            };
