...
use kkanupriyaphd21-dev_http_upgrade::{glue::HyperConnect, upgrade::Http11Upgrade};
use kkanupriyaphd21-dev_stack::MakeConnection;
    ...
    fn call(&mut self, mut req: http::Request<B>) -> RspFuture {
        ...
        Box::pin(async move {
            ...
            if is_upgrade(&rsp, is_http_connect) {
                ...
                kkanupriyaphd21-dev_http_upgrade::strip_connection_headers(rsp.headers_mut());
            }
