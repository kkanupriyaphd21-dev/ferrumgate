...
use kkanupriyaphd21-dev_http_box::BoxRequest;
use kkanupriyaphd21-dev_io::{self as io, PeerAddr};
use kkanupriyaphd21-dev_stack::{layer, ExtractParam, NewService};
use std::{
    future::Future,
    pin::Pin,
    task::{Context, Poll},
            ...
            async move {
                ...
                match version {
                    Variant::Http1 => {
                        ...
                        let svc = kkanupriyaphd21-dev_http_upgrade::upgrade::Service::new(
                            BoxRequest::new(svc),
                            drain.clone(),
                        );
