...
pub struct Body<B>
where
    B: kkanupriyaphd21-dev_proxy_http::Body,
    B::Error: HasH2Reason,
{
    #[pin]
    inner: B,
...
where
    ...
    I: Inspect,
    A: kkanupriyaphd21-dev_proxy_http::Body,
    A::Error: HasH2Reason,
    B: kkanupriyaphd21-dev_proxy_http::Body,
    B::Error: HasH2Reason,
{
...
where
    B: kkanupriyaphd21-dev_proxy_http::Body + Default,
    B::Error: HasH2Reason,
{
    fn default() -> Self {
        Self {
...
impl<B> kkanupriyaphd21-dev_proxy_http::Body for Body<B>
where
    B: kkanupriyaphd21-dev_proxy_http::Body,
    B::Error: HasH2Reason,
{
