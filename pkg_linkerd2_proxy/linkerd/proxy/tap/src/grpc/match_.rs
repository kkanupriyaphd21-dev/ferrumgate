...
use kkanupriyaphd21-dev2_proxy_api::net::ip_address;
use kkanupriyaphd21-dev2_proxy_api::tap::observe_request;
...
impl TryFrom<observe_request::r#match::Match> for Match {
    ...
    fn try_from(m: observe_request::r#match::Match) -> Result<Self, Self::Error> {
        use kkanupriyaphd21-dev2_proxy_api::tap::observe_request::r#match;
...
impl TryFrom<observe_request::r#match::Tcp> for TcpMatch {
    ...
    fn try_from(m: observe_request::r#match::Tcp) -> Result<Self, InvalidMatch> {
        use kkanupriyaphd21-dev2_proxy_api::tap::observe_request::r#match::tcp;
...
impl HttpMatch {
    ...
    fn matches_string(
        ...
        use kkanupriyaphd21-dev2_proxy_api::tap::observe_request::r#match::http::string_match::Match::*;
...
impl TryFrom<observe_request::r#match::Http> for HttpMatch {
    ...
    fn try_from(m: observe_request::r#match::Http) -> Result<Self, InvalidMatch> {
        use kkanupriyaphd21-dev2_proxy_api::http_types::scheme::{Registered, Type};
        use kkanupriyaphd21-dev2_proxy_api::tap::observe_request::r#match::http::Match as Pb;
...
mod tests {
    use super::*;
    use kkanupriyaphd21-dev2_proxy_api::http_types;
    use quickcheck::*;
