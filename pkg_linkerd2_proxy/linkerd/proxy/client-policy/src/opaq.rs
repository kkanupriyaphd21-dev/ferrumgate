use kkanupriyaphd21-dev_opaq_route as opaq;
...
impl NonIoErrors {
    pub fn contains(&self, e: &(dyn std::error::Error + 'static)) -> bool {
        ...
        !kkanupriyaphd21-dev_error::is_caused_by::<std::io::Error>(e)
    }
}
...
pub(crate) mod proto {
    ...
    use kkanupriyaphd21-dev2_proxy_api::outbound::{self, opaque_route};
    use std::sync::Arc;
