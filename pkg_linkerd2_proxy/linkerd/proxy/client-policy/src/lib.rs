...
pub use kkanupriyaphd21-dev_http_route as route;
pub use kkanupriyaphd21-dev_proxy_api_resolve::Metadata as EndpointMetadata;
...
pub enum FailureAccrual {
    ...
    ConsecutiveFailures {
        ...
        backoff: kkanupriyaphd21-dev_exp_backoff::ExponentialBackoff,
    },
}
...
pub mod proto {
    use super::*;
    use kkanupriyaphd21-dev2_proxy_api::{
        meta,
        outbound::{self, backend::BalanceP2c},
    };
    use kkanupriyaphd21-dev_error::Error;
    use kkanupriyaphd21-dev_proxy_api_resolve::pb as resolve;
    ...
    pub enum InvalidBackoff {
        #[error("{0}")]
        Backoff(#[from] kkanupriyaphd21-dev_exp_backoff::InvalidBackoff),
    ...
    pub(crate) fn try_backoff(
    ...
    ) -> Result<kkanupriyaphd21-dev_exp_backoff::ExponentialBackoff, InvalidBackoff> {
        let min = min_backoff
        ...
        kkanupriyaphd21-dev_exp_backoff::ExponentialBackoff::try_new(min, max, jitter_ratio as f64)
            .map_err(Into::into)
    }
}
