use futures::prelude::*;
use kkanupriyaphd21-dev_error::{Error, Recover, Result};
use kkanupriyaphd21-dev_exp_backoff::{ExponentialBackoff, ExponentialBackoffStream};
use kkanupriyaphd21-dev_identity::DerX509;
use kkanupriyaphd21-dev_identity::{Credentials, Id};
use kkanupriyaphd21-dev_proxy_http as http;
use kkanupriyaphd21-dev_tonic_watch::StreamWatch;
...
impl Recover<tonic::Status> for GrpcRecover {
    ...
    fn recover(&self, status: tonic::Status) -> Result<Self::Backoff, tonic::Status> {
        ...
        // https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/a5b6456ff1bcdb6935f61ed7f83e8ee533a325a3/standards/SPIFFE_Workload_API.md#client-state-machine
