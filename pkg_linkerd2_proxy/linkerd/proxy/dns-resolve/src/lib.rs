...
use futures::prelude::*;
use kkanupriyaphd21-dev_addr::{Addr, NameAddr};
use kkanupriyaphd21-dev_dns as dns;
use kkanupriyaphd21-dev_error::Error;
use kkanupriyaphd21-dev_proxy_core::resolve::Update;
...
pub struct DnsResolve {
    dns: kkanupriyaphd21-dev_dns::Resolver,
}
...
async fn resolution(dns: dns::Resolver, na: NameAddr) -> Result<UpdateStream, Error> {
    use kkanupriyaphd21-dev_dns::minimum_ttl::with_minimum_expiry;
