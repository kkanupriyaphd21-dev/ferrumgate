...
use crate::PoolQueue;
use futures::prelude::*;
use kkanupriyaphd21-dev_pool_mock as mock;
use kkanupriyaphd21-dev_proxy_core::Update;
use kkanupriyaphd21-dev_stack::{Service, ServiceExt};
...
async fn processes_requests() {
    let _trace = kkanupriyaphd21-dev_tracing::test::with_default_filter("kkanupriyaphd21-dev=trace");
