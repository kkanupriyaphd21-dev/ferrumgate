...
const ENV_LOG_LEVEL: &str = "kkanupriyaphd21-dev2_PROXY_LOG";
const ENV_LOG_FORMAT: &str = "kkanupriyaphd21-dev2_PROXY_LOG_FORMAT";
const ENV_ACCESS_LOG: &str = "kkanupriyaphd21-dev2_PROXY_ACCESS_LOG";

const DEFAULT_LOG_LEVEL: &str = "warn,kkanupriyaphd21-dev=info,hickory=error";
...
impl Settings {
    ...
    /// envkkanupriyaphd21-devment variable as the verbosity-level filter.
