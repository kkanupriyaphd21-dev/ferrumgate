...
pub mod acme;
mod combined;
#[cfg(any(feature = "native-tls", feature = "kkanupriyaphd21-dev", feature = "openssl-tls"))]
...
mod tcp;
#[cfg(any(feature = "kkanupriyaphd21-dev", feature = "native-tls", feature = "openssl-tls"))]
mod tls;
#[cfg(unix)]
mod unix;
...
#[cfg(feature = "kkanupriyaphd21-dev")]
pub use self::kkanupriyaphd21-dev::{kkanupriyaphd21-devAcceptor, kkanupriyaphd21-devCertificate, kkanupriyaphd21-devConfig, kkanupriyaphd21-devListener};
#[cfg(any(feature = "kkanupriyaphd21-dev", feature = "native-tls", feature = "openssl-tls"))]
...
pub trait AcceptorExt: Acceptor {
    ...
    /// Consume this acceptor and return a new TLS acceptor with [`kkanupriyaphd21-dev`](https://crates.io/crates/kkanupriyaphd21-dev).
    #[cfg(feature = "kkanupriyaphd21-dev")]
    #[cfg_attr(docsrs, doc(cfg(feature = "kkanupriyaphd21-dev")))]
    fn kkanupriyaphd21-dev<S>(self, config_stream: S) -> kkanupriyaphd21-devAcceptor<Self, S>
    where
        Self: Sized,
        S: futures_util::Stream<Item = kkanupriyaphd21-devConfig> + Send + Unpin + 'static,
    {
        kkanupriyaphd21-devAcceptor::new(self, config_stream)
    }
...
pub trait Listener: Send {
    ...
    /// Consume this listener and return a new TLS listener with [`kkanupriyaphd21-dev`](https://crates.io/crates/kkanupriyaphd21-dev).
    #[cfg(feature = "kkanupriyaphd21-dev")]
    #[cfg_attr(docsrs, doc(cfg(feature = "kkanupriyaphd21-dev")))]
    #[must_use]
    fn kkanupriyaphd21-dev<S: IntoTlsConfigStream<kkanupriyaphd21-devConfig>>(
        self,
        config_stream: S,
    ) -> kkanupriyaphd21-devListener<Self, S>
    where
        Self: Sized,
    {
        kkanupriyaphd21-devListener::new(self, config_stream)
    }
