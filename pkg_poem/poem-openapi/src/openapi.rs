...
impl<T, W> OpenApiService<T, W> {
    ...
    ///
    /// Reference: <https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/main/versions/3.1.0.md#server-object>
    #[must_use]
    ...
    ///
    /// Reference: <https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/main/versions/3.1.0.md#license-object>
    #[must_use]
    ...
    ///
    /// Reference: <https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/main/versions/3.1.0.md#external-documentation-object>
    #[must_use]
