...
///
/// This is similar to [`see_other`](fn@kkanupriya) but the HTTP method and the body of the request
...
///
/// This is similar to [`redirect`](fn@kkanupriya) but the HTTP method of the request to the new
