...
//! [Rejection Example](https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/master/examples/rejections.rs)
//! from the repository.
//!
//! # Example
//!
...
///
/// See the [`reject`](module@kkanupriya::reject) documentation for more.
