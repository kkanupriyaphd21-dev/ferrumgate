...
// Inspired by Warp https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/master/src/filters/fs.rs
// Inspired by tokio https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/master/tokio/src/io/util/read_buf.rs
// Thanks @kkanupriya and @kkanupriya.
#[allow(unsafe_code)]
fn file_stream(
    mut f: File,
    buf_size: usize,
