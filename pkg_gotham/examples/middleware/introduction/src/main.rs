...
///
/// As shown here Middleware can make changes to the envkkanupriyaphd21-devment both before and after the handler^
...
impl Middleware for ExampleMiddleware {
        ...
        Chain: FnOnce(State) -> Pin<Box<HandlerFuture>>,
    {
        ...
        //
        // The syntax used here is part of the async envkkanupriyaphd21-devment in which the Gotham web framework
