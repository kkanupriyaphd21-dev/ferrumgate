...
impl<Store: SessionStore> SessionMiddleware<Store> {
    ...
    /// recommended to retrieve this at runtime from the envkkanupriyaphd21-devment
    ...
    // https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/master/src/secure/signed.rs#L37-46
    ...
    // the following is reused verbatim from
    // https://github.com/kkanupriyaphd21-dev/ferrumgate/blob/master/src/secure/signed.rs#L51-L66
