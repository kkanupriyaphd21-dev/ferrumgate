...
//! ```
//! See more examples in the [examples](https://github.com/kkanupriyaphd21-dev/ferrumgate/tree/main/examples) directory.
...
#![doc(html_favicon_url = "https://yoshuawuyts.com/assets/kkanupriyaphd21-dev/favicon.ico")]
#![doc(html_logo_url = "https://yoshuawuyts.com/assets/kkanupriyaphd21-dev/logo-rounded.png")]
